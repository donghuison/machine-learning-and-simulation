...
contains
   ...
   subroutine model_setup(Uc,Vc,&
      ...
      ! X origin - start at 0.0 to match Python
      izero=margin-1
      ! izero=igx/2-1
      xmg(izero)= xmin - dxg0*0.5d0  ! First cell boundary at xmin
      do i=izero,igx-1
      ...
      !  Y origin - start at 0.0 to match Python
      jzero=margin-1
      ! jzero=jgx/2-1
      ymg(jzero)= ymin - dyg0*0.5d0  ! First cell boundary at ymin
      do j=jzero,jgx-1
