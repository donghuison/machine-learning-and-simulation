...
def main():
    ...
    base_dirs = {
        'StableFluid': '/Users/donghuison/workspace/myGit/KHU-STUDY/Project-01/machine-learning-and-simulation/english/simulation_scripts/fortran/HD_stableFluid/'
    }
    
    # Select current problem
    # current_scheme = 'LidDrivenCavity'
    current_problem = 'StableFluid'

    base_dir = base_dirs[current_problem]
    ...
    for t in time_range:
        ...
        # Save the plot
        output_filename = os.path.join(output_dir, f'pr_vel_{t}_{data_type}_{current_problem}.pdf')
